...
public class RNSoundModule extends ReactContextBaseJavaModule implements AudioManager.OnAudioFocusChangeListener {
  ...
  Boolean forceOutputSpeaker = false;
  ...
  @ReactMethod
  public void forceOutputOnSpeaker(Boolean value) {
    this.forceOutputSpeaker = value;
  }
