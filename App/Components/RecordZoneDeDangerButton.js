...
import { View, Text, TouchableOpacity, Image, Platform, Modal, StyleSheet } from 'react-native'
...
export default class RecordButton extends Component {
  ...
  static propTypes = {
    ...
    onCompletedVoiceZoneDeDanger: PropTypes.func,
  }
  ...
  onSaveRecordSuccess(data) {
    ...
    this.props.onCompletedVoiceZoneDeDanger(true, data)
